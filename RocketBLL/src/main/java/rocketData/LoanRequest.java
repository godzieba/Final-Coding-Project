...
public class LoanRequest implements Serializable {
	...
	private double dHousingPayment;
	...
	public double getdHousingPayment() {
		return dHousingPayment;
	}
	public void setdHousingPayment(double dHousingPayment) {
		this.dHousingPayment = dHousingPayment;
	}
